...
export default function BookVehicle() {
  ...
  const bookingType = type || (vehicleData ? 'vehicle' : tourData ? 'tour' : 'general');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const bookingData = {
        ...
        itemName: itemData?.name || itemData?.title || 'General Booking',
        itemCategory: itemData?.category || '',
        itemType: itemData?.type || bookingType,
      ...
      if (db) {
        ...
        console.log('Booking data (Firebase not configured):', bookingData);
      }
  ...
  // If no item data and not a general booking, show error
      ...
      <div className="book-vehicle-page">
        <div className="container">
          <div className="booking-error-state">
            ...
            <p>Please select a vehicle or tour package to book.</p>
  ...
  return (
    <div className="book-vehicle-page">
          ...
          <div className="container">
            <div className="hero-content" data-aos="fade-up">
              <div className="hero-text">
                <h1>{itemData?.name || itemData?.title || 'Complete Booking'}</h1>
      ...
      <div className="container">
        {success ? (
          <div className="booking-success-page" data-aos="fade-up">
            <div className="success-card">
              <div className="success-icon">
                <i className="fas fa-check-circle"></i>
              </div>
              <h2>Booking Submitted Successfully!</h2>
              <p>Thank you for booking <strong>{itemData?.name || itemData?.title || 'our services'}</strong></p>
              ...
              <div className="success-summary">
                ...
                <div className="summary-row total">
                  ...
                  <span>Estimated Total: ₹{estimatedPrice}</span>
                </div>
              </div>
              ...
              <div className="success-info">
                <i className="fas fa-clock"></i>
                <span>Our team will confirm your booking and contact you shortly</span>
              </div>
          ...
          <div className="booking-form-container">
            <div className="booking-grid">
                  ...
                  <div className="item-card">
                    ...
                    <div className="item-info">
                      ...
                      <div className="item-price">
                        ...
                        <span className="per-unit">/ {bookingType === 'tour' ? 'person' : 'day'}</span>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="booking-right" data-aos="fade-left">
                {/* Price Summary */}
                ...
                <p className="booking-note">
                  <i className="fas fa-info-circle"></i>
                  Your booking will be confirmed once verified by our team. No payment required now.
                </p>
              </div>
            </div>
          </div>
